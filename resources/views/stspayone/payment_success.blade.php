    ...
    <div class="container">
        <div class="row">
            <div class="text-center">
                <img src="{{ asset('/payment/payment-success.gif') }}" class="payment_successImg">
                <h1 class="payment-succes-title">Payment Success!</h1>
                <p class="payment-content">Thank you for your payment</p>
                <br>
